...
import TicTac from '../public/projectPics/tictac.png'
import Memory from '../public/projectPics/memory.png'
import MangaFront from '../public/projectPics/mangaFront.png'
import MangaBack from '../public/projectPics/mangaBack.png'
import DadJokes from '../public/projectPics/dadJokes.png'
import GameOfWar from '../public/projectPics/gameOfWar.png'
import Portfolio from '../public/projectPics/portfolio.png'
import Dad2 from '../public/projectPics/dad2.png'
import ToDoList from '../public/projectPics/toDoList.png'
import Weather from '../public/projectPics/weather.png'
...
export default function Home() {
  ...
  const getAllProj = (array, index) => {
    ...
    for (let i = 0; i < array.length; i++) {
      projectsArr.push(<ProjectCard projObj={array[i]} key={i} />)
    }
    return projectsArr;
  }
  ...
  return (
    <>
      <div className={styles.main}>
        <Navbar />
        <Typography variant='h2'className={styles.title}>View My Projects Below</Typography>
        <div className={styles.projectContainer}>
          {allProjects}
        </div>
      </div>
      <Divider variant='center' className={styles.divider}/>
      <Footer/>
    </>
  )
}
